...
export const PLATFORM_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/platform/infrastructure", label: "Infrastructure", icon: Server,       match: (p) => p.startsWith("/platform/infrastructure") },
      { href: "/platform/monitoring",     label: "Monitoring",     icon: Activity,     match: (p) => p.startsWith("/platform/monitoring") },
