/**
 * Card primitives — ported from roshn/src/components/ui/Card.tsx.
 * Same shape, IOX zinc-200 border + white bg defaults.
 */
...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      data-slot="card"
      className={cn(
        "bg-white text-zinc-900 flex flex-col gap-6 rounded-xl border border-zinc-200 py-6",
        className,
      )}
      {...props}
    />
